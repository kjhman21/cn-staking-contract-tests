...
async function add_pd_admin() {
  ...
  // add new admin.
  console.log(`Adding pd to new admin ${cn1.pd_addr}`)
  await c.methods.submitAddAdmin(cn1.pd_addr).send({from:cn1.new_admin.address, gas:4000000, value:0})
